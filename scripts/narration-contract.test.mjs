...
test("narration verification contract stays fail-closed", () => {
  ...
  assert.ok(contract.requirements.generationInput.some((value) => value.includes("before audio results exist")));
  ...
  assert.match(contract.driftPolicy, /Generation input/i);
